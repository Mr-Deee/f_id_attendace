...
import 'package:f_id_attendace/utils/auth_service.dart';
import 'package:f_id_attendace/screens/class_details_screen.dart';
import 'package:f_id_attendace/screens/auth/login_screen.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  Future _scanQR() async {
    try {
      ...
      DocumentSnapshot data = await users.document(uid).get();
      setState(() {
        result = qrResult;
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: FutureBuilder(
                  future:
                      users.document((context.watch<User>().uid).toString()).get(),
